...
class _ScreenAddProductState extends State<ScreenAddProduct> {
  ...
  TextEditingController chitietController =TextEditingController();
            ...
            child: Column(
              ...
              children: [
                ...
                CustomInfoProduct(
                  ...
                  onChanged: (value){
                    setState(() {
                      TextSelection previousSelection = dongiaController.selection;
                      dongiaController.text =value;
                      dongiaController.selection = previousSelection;
                    });
                  },
                  textInputType: TextInputType.multiline,
                  textInputAction: TextInputAction.next,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("MaNSX "+ maNSX),
                  Text("MaNCC "+ maNCC),
                  Text("NgayCap "+ dateFormat.format(selectedDate)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomInfoProduct(
                    ...
                    onChanged: (value){
                      setState(() {
                        TextSelection previousSelection = tenSpController.selection;
                        tenSpController.text =value;
                        tenSpController.selection = previousSelection;
                      });
                    },
                    textInputType: TextInputType.emailAddress,
                    textInputAction: TextInputAction.next,
                  ...
                  CustomInfoProduct(
                    ...
                    onChanged: (value){
                      setState(() {
                        TextSelection previousSelection = motaController.selection;
                        motaController.text =value;
                        motaController.selection = previousSelection;
                      });
                    },
                    textInputType: TextInputType.multiline,
                    textInputAction: TextInputAction.next,
                  ...
                  CustomInfoProduct(
                    ...
                    onChanged: (value){
                      setState(() {
                        TextSelection previousSelection = chitietController.selection;
                        chitietController.text =value;
                        chitietController.selection = previousSelection;
                      });
                    },
                    textInputType: TextInputType.multiline,
                    textInputAction: TextInputAction.next,
                  ...
                  CustomInfoProduct(
                    ...
                    onChanged: (value){
                      setState(() {
                        TextSelection previousSelection = soluongController.selection;
                        soluongController.text =value;
                        soluongController.selection = previousSelection;
                      });
                    },
                    textInputType: TextInputType.multiline,
                    textInputAction: TextInputAction.next,
