...
class _ScreenOrderState extends State<ScreenOrder> {
  ...
  _getDonHang(){
    EasyLoading.show(status: 'Loading Order...');
                              ...
                              onTapDown: (TapDownDetails details){
                                ...
                                setState(() {
                                  ...
                                  _showPopupMenu(
                                      ...
                                      overlay,
                                      (){
                                        donHang.edit_dh_tinhtranggh(models_dondh[index].MaDDH, "ok", context).then((value){
                                          if(value == "success")
                                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)
                                            => ScreenPageAdmin(email: "", currentTools: 3,)));
                                          Fluttertoast.showToast(msg: "Accept : ${models_dondh[index].MaDDH}");
                                        });
                                      },
                                      (){
                                        donHang.edit_dh_tinhtranggh(models_dondh[index].MaDDH, "dang", context).then((value){
                                          if(value == "success")
                                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)
                                            => ScreenPageAdmin(email: "", currentTools: 3,)));
                                            Fluttertoast.showToast(msg: "Reject : ${models_dondh[index].MaDDH}");
                                        });
                                      },
                                  );
                                });
