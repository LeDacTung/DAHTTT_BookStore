          ...
          children: [
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    if(widget.currentTools  ==0)
                      ScreenPageThongKe(),
                    if(widget.currentTools  ==1)
                       ScreenPageUser(),
                    if(widget.currentTools  ==2)
                      ScreenPageProduct(),
                    if(widget.currentTools  ==3)
                      ScreenOrder(),
