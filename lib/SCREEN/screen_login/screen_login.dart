...
import 'package:flutter_doan/SCREEN/screen_singup.dart';
...
class _ScreenLoginState extends State<ScreenLogin> {
  ...
  TextEditingController _passControllerSignIn=  new TextEditingController();
                            ...
                            StreamBuilder(
                                ...
                                builder: (context, snapshot){
                                  return  CustomTextFielPasseword(
                                      ...
                                      textInputAction: TextInputAction.next,
                                    controller: _passControllerSignIn,
                                  );
                                }
                            ),
                                  ...
                                  loginAdminUser(emailSignIn, passSignIn).then((value){
                                    ...
                                    if(modelTvs.length == 0){
                                      ...
                                      if(modelTvs[0].MaLoaiTV == "1"){
                                        ...
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => ScreenPageAdmin(email: modelTvs[0].EmailThanhVien, currentTools: 0,))
                                        );
