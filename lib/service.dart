...
class SanPham{
 ...
 class DonHang{
  ...
  Future<String> edit_dh_tinhtranggh(maddh, tinhtrang, context) async {
    var url ="https://ledtandroid.000webhostapp.com/doan_kiemthu/edit_dh_tinhtranggh.php";
...
Future<String> signUpUser(email, pass, ht, dc, sdt, ch, ctrl, mltv) async {
  var url ="https://ledtandroid.000webhostapp.com/doan_kiemthu/signup_user.php";
  var response = await http.post(
    Uri.parse(url),
    body: {
      "EmailThanhVien" : email,
